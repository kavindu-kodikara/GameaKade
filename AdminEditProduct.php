                        ...
                        <div class="col-12 p-4">
                            <div class="row">
                                ...
                                <div class="col-12 ps-4">
                                    <div class="row">
                                        <div class="col-4 col-lg-6 fs-4 fw-bold">Edit Product</div>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="row">
                                        <div class="col-12 center">
                                            <img src="<?php echo ($p_data["path"]) ?>" class="rounded rounded-4" style="width: 200px; height: 150px;">
                                        </div>
                                        <div class="col-8 col-lg-4 offset-2 offset-lg-4 mt-3">
                                            <div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-3">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="title" value="<?php echo ($p_data["title"]) ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12 mt-3">
                                                    <label for="ctg" class="form-label">Product Category</label>
                                                    <select id="ctg" class="form-select" aria-label="Default select example" style="font-family: 'sinhala';" onclick="adminselectSize(<?php echo($cid); ?>,<?php echo($pId); ?>)">
                                                        <option style="font-family: 'sinhala';" selected value="<?php echo($cid); ?>"><?php echo ($p_data["name"]) ?></option>
                                                        <?php

                                                        $ct_rs = Database::search("SELECT * FROM `category`");

                                                        for ($x = 0; $x < $ct_rs->num_rows; $x++) {
                                                            $ct = $ct_rs->fetch_assoc();
                                                        ?>
                                                            <option style="font-family: 'sinhala';" value="<?php echo ($ct["id"]); ?>"><?php echo ($ct["name"]); ?></option>
                                                        <?php
                                                        }
                                                ...
                                                ?>
                                                    <div class="col-6 mt-3">
                                                        <div>
                                                            <label for="p_half" class="form-label">Half Price</label>
                                                            <input type="text" class="form-control" id="p_half" value="<?php echo ($p_data["price"]) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-6 mt-3">
                                                        <div>
                                                            <label for="p_full" class="form-label">Full Price</label>
                                                            <input type="text" class="form-control" id="p_full" value="<?php echo ($p_data["price_full"]) ?>">
                                                        </div>
                                                    </div>
                                                <?php
                                                } else {
                                                ?>
                                                    <div class="col-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control" id="price" value="<?php echo ($p_data["price"]) ?>">
                                                        </div>
                                                    </div>
                                                <?php
                                                }
                                                ...
                                                <div class="col-12 mt-3 d-flex justify-content-end">
                                                    <button class="btn btn-primary px-5" onclick="editProduct(<?php echo ($pId); ?>);">SAVE</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
