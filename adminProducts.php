                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-10 offset-lg-1 offset-0">
                                <div class="row">
                                    <div class="col-7">
                                        <div>
                                            <input id="txt" type="text" class="form-control rounded rounded-4" placeholder="Product name...." onkeyup="adminSearch();">
                                        </div>
                                    </div>
                                    <div class="col-5 col-lg-3">
                                        <select id="select" onclick="adminSearch();" class="form-select rounded rounded-4" aria-label="Default select example" style="font-family: 'sinhala';">
                                    ...
                                    <div class="col-2 d-grid d-none d-lg-block">
                                        <button class="btn btn-primary rounded rounded-4">Search</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                <div class="row">
                                    <div class="col-6  fs-5 fw-bold" style="font-family: 'sinhala';">Products</div>
                                    <div class="col-6 col-lg-2 offset-0 offset-lg-4 pt-2 cursor btnActive" onclick="window.location='adminAddNewProduct.php'" style="font-family: 'sinhala';"><i class="bi bi-plus-circle-dotted"></i>&nbsp;Add New Product</div>
                                </div>
                            </div>
