...
<head>
    ...
    <title>My Cancellation | ගමේ කඩේ</title>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row">
                                                                ...
                                                                $recent_rs = Database::search("SELECT * FROM `recent` WHERE `user_email` = '" . $_SESSION["u"]["email"] . "'");
                                                                ...
                                                                $selected_rs = Database::search("SELECT * FROM `recent` WHERE `user_email` = '" . $_SESSION["u"]["email"] . "' ORDER BY `date` DESC
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="row">
                                                                                    <div class="col-12 col-lg-10">
                                                                                        <div class="row">
                                                                                            <div class="col-12">Order <span class="text-primary">#00<?php echo ($selected_data["order_id"]); ?></span></div>
                                                                                            <?php
                                                                                            $dateTime = date("Y M d - h:i a", strtotime($selected_data["date"]));
                                                                                            ?>
                                                                                            <div class="col-12">Canceled on :- <?php echo ($dateTime); ?></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-12 mt-2">
                                                                                <div class="row">
                                                                                    ...
                                                                                    $p_rs = Database::search("SELECT * FROM `product_has_recent` INNER JOIN `product` ON `product`.`id` = `product_has_recent`.`product_id`
                                                                                    INNER JOIN `product_img` ON `product_img`.`product_id` = `product`.`id` INNER JOIN `recent` 
                                                                                    ON `product_has_recent`.`recent_recent_id` =  `recent`.`recent_id` WHERE `product_has_recent`.`recent_recent_id` = '" . $id . "'");
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        <div class="col-12 pb-3 mb-3">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-6 pt-4 pt-lg-0 col-lg-3 center">
                                                                                                    <div class="row">
                                                                                                        <div class="bg-danger text-white rounded-4 p-1 px-3 fw-bold">Canceled</div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-6 col-lg-2 pt-4 pt-lg-0 center">qty :- <?php echo ($p_data["qty"]); ?></div>
                                                                                            </div>
                                                                                            <?php
                                                                                            if ($p_rs->num_rows > 1) {
                                                                                            ?>
